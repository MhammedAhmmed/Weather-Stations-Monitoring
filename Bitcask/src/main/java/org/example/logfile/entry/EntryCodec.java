...
public final class EntryCodec{
     ...
     * @return
     */
    public static <K extends BitCaskKey> byte[] encode(Entry<K> entry) {
     ...
     * @return
     */
    public static <K extends BitCaskKey> List<MappedStoredEntry<K>> decodeMulti(byte[] content, Function<byte[], K> keyMapper) {
